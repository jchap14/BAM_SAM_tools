...
##### Run these 2 commands to create BAM folder & move all bams there
# mkdir BAMs
# mv `find . -name "*bam*"` ./BAMs/

##### Submit this script for RNAseq
## for x in `find . -name "*.sortedByCoord.out.bam"` ; do bash samtools_index_stats.CnR.sh $x; done
